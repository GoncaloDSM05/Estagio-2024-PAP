...
// Defina sua senha de e-mail
$senhaEmail = getenv('SENHA_EMAIL');
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($resultado && $resultado->num_rows > 0) {
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'squadforgeese@gmail.com'; // Substitua pelo seu email real
                $mail->Password = $senhaEmail; // Substitua pela sua senha real
                $mail->SMTPSecure = 'tls';
                $mail->Port = 587;

                $mail->setFrom('squadforgeese@gmail.com', 'SquadForge'); // Substitua pelo seu email real
        ...
        // Tratamento para quando o email não é válido
        header("Location: ../../pedidoredefinirpp.html?notification=error&reason=invalidEmail");
    }
} else {
